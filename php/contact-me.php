...
if($_POST) {
    ...
    $to_Email = 'devang.dsshah@gmail.com'; // Write your email here to receive the form submissions
    $subject = 'New message from CS'; // Write the subject you'll see in your inbox
